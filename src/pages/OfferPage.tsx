    ...
    return (
        <>
            <div className='flex justify-between h-1/2 m-4 border rounded-lg shadow bg-gray-100 font-mono'>
                <Image source={shoe} style='w-64 h-96 p-4 m-2' />
                ...
                <div className='flex flex-col gap-8 p-6 m-5'>
                    <Image source={shipping} style='w-24 h-20' />
                    <Image source={exchange} style='w-24 h-20' />
                    <Image source={support} style='w-24 h-20' />
                </div>
                <div className='flex items-center'>
                    <Image source={offer} style='w-96 h-64 p-4' />
                </div>
            </div>
        </>
    );
